...
using Xzy.SK.Domain.Repositories.Base;
...
namespace Xzy.SK.Domain.Repositories
{
    public class Repository<T> : SimpleClient<T> where T : class, new()
    {
        ...
        public static SqlSugarScope SqlServerDb = SqlSugarHelper.SqlServerDb;

        public SimpleClient<T> CurrentDb { get { return new SimpleClient<T>(SqlServerDb); } }//用来处理T表的常用操作
